...
func IsBetween(s df.DataFrameSeries, min time.Time, max time.Time, between series.BetweenInclude) (r df.DataFrameSeries) {
...
func IsCompare(s df.DataFrameSeries, dt time.Time, condition series.CompareCondition) (r df.DataFrameSeries) {
