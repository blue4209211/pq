...
func (t *xmlDataSource) Writer(data df.DataFrame, args map[string]string) (DataFrameWriter, error) {
	return &xmlDataSourceWriter{data: data, args: args}, nil
}

func (t *xmlDataSource) Reader(reader io.Reader, args map[string]string) (DataFrameReader, error) {
